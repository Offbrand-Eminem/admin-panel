...
public class Check extends GrimProcessor implements AbstractCheck {
    ...
    public final void updatePermissions() {
        ...
        exemptPermission = player.hasPermission("sugaryac.exempt." + id);
        noSetbackPermission = player.hasPermission("sugaryac.nosetback." + id);
        noModifyPacketPermission = player.hasPermission("sugaryac.nomodifypacket." + id);
    }
