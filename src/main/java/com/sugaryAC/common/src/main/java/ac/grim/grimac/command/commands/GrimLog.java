...
public class GrimLog implements BuildableCommand {
    ...
    private static void sendLog(Sender sender, String log, String success, String failure, Consumer<String> consumer, String type) throws IOException {
        ...
        try {
            ...
            urlConn.addRequestProperty("User-Agent", "sugaryAC/" + GrimAPI.INSTANCE.getExternalAPI().getGrimVersion());
    ...
    public void register(CommandManager<Sender> commandManager, CloudPlatformCommandArguments arguments) {
        Command<Sender> command = commandManager.commandBuilder("sugaryac", "sugaryAC")
                .literal("log", "logs")
                .permission("sugaryac.log")
