    ...
    private static void checkForUpdates(Sender sender) {
        try {
            ...
            HttpRequest request = HttpRequest.newBuilder()
                    ...
                    .GET()
                    .header("User-Agent", "sugaryAC/" + GrimAPI.INSTANCE.getExternalAPI().getGrimVersion())
            ...
            if (statusCode < 200 || statusCode >= 300) {
                ...
                sender.sendMessage(Objects.requireNonNullElseGet(msg, () -> Component.text()
                        ...
                        .append(Component.text(" Failed to check latest sugaryAC version. Update server responded with status code: ")
            ...
            Component msg = switch (status) {
                case AHEAD ->
                        Component.text("You are using a development version of sugaryAC").color(NamedTextColor.LIGHT_PURPLE);
                case UPDATED ->
                        Component.text("You are using the latest version of sugaryAC").color(NamedTextColor.GREEN);
                case OUTDATED -> Component.text()
                        .append(Component.text("New sugaryAC version found!").color(NamedTextColor.AQUA))
                        ...
                        .build();
                case UNKNOWN ->
                        Component.text("You are using an unknown sugaryAC version.").color(NamedTextColor.RED);
            };
            ...
            LogUtil.error("Failed to check latest sugaryAC version.", e);
        }
    }
