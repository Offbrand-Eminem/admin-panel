...
/**
 * Persistence facade for the per-player toggle state behind {@code /sugaryac alerts},
 * {@code /sugaryac verbose}, {@code /sugaryac brands}. Per-online-player cache; the DB
