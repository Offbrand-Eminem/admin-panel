...
public class GrimPlayer implements GrimUser {
    ...
    public void updatePermissions() {
        runSafely(() -> {
            try {
                boolean noModifyPacketPermission = hasPermission("sugaryac.nomodifypacket");
                boolean noSetbackPermission = hasPermission("sugaryac.nosetback");
                boolean disabledPermission = hasPermission("sugaryac.disabled");
                boolean exemptPermission = hasPermission("sugaryac.exempt");
