...
public class PlayerDataManager {
    ...
    public boolean shouldCheck(@NotNull User user) {
        ...
        if (user.getUUID() != null) {
            ...
            if (grimPlayer != null && grimPlayer.hasPermission("sugaryac.exempt")) {
                exemptUser(user);
                return false;
            }
    ...
    public void onDisconnect(User user) {
        ...
        // AND go NOOP mid-session if an operator runs /sugaryac reload after flipping database.enabled to false
